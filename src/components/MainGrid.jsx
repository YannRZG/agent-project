    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-4 px-8 min-h-[60vh]">
        ...
        <div className="bg-zinc-800 rounded-lg text-white flex h-full transform hover:scale-105 transition-transform duration-300 ease-in-out">
          <button className="flex items-end h-full w-full p-4 rounded-lg shadow-md bg-center bg-no-repeat lg:bg-[url('/src/assets/items.png')] lg:bg-[length:80%] lg:bg-[top]" onClick={() => navigate("/collection")}>
        ...
        <div className="flex flex-col h-full space-y-4 hidden lg:flex">
          ...
          onClick={() => navigate("/farming")}
            ...
            style={{
              backgroundImage: "url('/src/assets/custom-league.png')",
        ...
        <div className="space-y-4 flex flex-col h-full">
          <button onClick={() => navigate("/profile")} className="flex items-end h-1/6 p-2 rounded-lg shadow-md bg-zinc-800 text-white transform hover:scale-105 transition-transform duration-300 ease-in-out hidden lg:flex">
